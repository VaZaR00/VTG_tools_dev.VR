...
class CfgFunctions
{
	...
	class EMM
	{
		...
		class Functions
		{
			...
			class getClassPicture { file = "functions\Functions\Items\fn_getClassPicture.sqf"; };
			...
			class setRandomized { file = "functions\Functions\ModuleInventory\fn_setRandomized.sqf"; };
			class initPreset { file = "functions\Functions\Presets\fn_initPreset.sqf"; };
			class wipePreset { file = "functions\Functions\Presets\fn_wipePreset.sqf"; };
			class storageMiddleware { file = "functions\Functions\repository\fn_storageMiddleware.sqf"; };
			class clearSearch { file = "functions\Functions\Shared\fn_clearSearch.sqf"; };
			class copyClassname { file = "functions\Functions\Shared\fn_copyClassname.sqf"; };
			class loadUserSettings { file = "functions\Functions\Shared\fn_loadUserSettings.sqf"; };
			class message { file = "functions\Functions\Shared\fn_message.sqf"; };
			class onSearchKeyUp { file = "functions\Functions\Shared\fn_onSearchKeyUp.sqf"; };
			class treeMapper { file = "functions\Functions\Shared\fn_treeMapper.sqf"; };
			class addItem { file = "functions\Functions\treeElements\fn_addItem.sqf"; };
			class deleteItem { file = "functions\Functions\treeElements\fn_deleteItem.sqf"; };
			class modifyItem { file = "functions\Functions\treeElements\fn_modifyItem.sqf"; };
			...
			class clearPreset { file = "functions\Functions\Presets\menu\fn_clearPreset.sqf"; };
			class export { file = "functions\Functions\Presets\menu\fn_export.sqf"; };
			class import { file = "functions\Functions\Presets\menu\fn_import.sqf"; };
			class openPresetManager { file = "functions\Functions\Presets\menu\fn_openPresetManager.sqf"; };
			class getFolders { file = "functions\Functions\repository\Folders\fn_getFolders.sqf"; };
			...
			class addPreset { file = "functions\Functions\repository\Presets\fn_addPreset.sqf"; };
			class deletePreset { file = "functions\Functions\repository\Presets\fn_deletePreset.sqf"; };
			class getPresetData { file = "functions\Functions\repository\Presets\fn_getPresetData.sqf"; };
			class setPresetData { file = "functions\Functions\repository\Presets\fn_setPresetData.sqf"; };
			...
			class modulesAmount { file = "functions\Functions\repository\Modules\Common\fn_modulesAmount.sqf"; };
			class saveModule { file = "functions\Functions\repository\Modules\Common\fn_saveModule.sqf"; };
