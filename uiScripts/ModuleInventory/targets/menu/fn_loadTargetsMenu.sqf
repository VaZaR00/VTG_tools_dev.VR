...
private _moduleTargets = if (VTG_Current_Module != "none") then {
	([false, true, VTG_Current_Module] call VTG_fnc_getModulesStorage)#0;
} else { [] };
...

{
...

	{
		...
		_name = _x call VTG_fnc_getClassDisplayName;
