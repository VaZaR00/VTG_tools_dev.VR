private _display = EMM_var_disp_MODULE_MANAGER;
...
private _arsenalCategories = _display displayCtrl 6355;     //7
...
private _presetLbl = _display displayCtrl 6678;
...
[
    ...
    _arsenalCategories,     //6  -  ars categ
