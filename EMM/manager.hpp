...
class EMM_EquipmentModulesManager {
	...
	class controls {
		class Current_preset_lbl: RscText
		{
			idc = 6678;
			style = 2;
		...
		class Menu: EMM_DBUG_MENU_STRIP
		{
			...
			class items
			{
				...
				{
					text="Clear Preset";
					action = "[ctrlParent (_this#0), true] call EMM_fnc_clearPreset";
				...
				class Category_operations_grp : RscControlsGroupNoScrollbars
				{
					...
					class controls 
					{
						...
						class Nest_category_Btn: RscButton
						{
							...
							onButtonClick = "[(EMM_var_ActiveModuleTab#1), tvCurSel (EMM_var_ActiveModuleTab#1)] call EMM_fnc_onModuleItemDbClick;";
						};
						class Clear_module_Btn: RscButton
						{
							...
							onButtonClick = "tvClear (EMM_var_ActiveModuleTab#1); [false] call EMM_fnc_setNestParent;";
						};
					};
				};
		...
		class start_window: RscControlsGroupNoScrollbars
		{
			...
			class controls 
			{
				class start_hello_Lbl: RscText
				{
					...
					text = "Hello! \nWelcome to Equipment Modules Manager! \nOpen/create new module or open preset"; //--- ToDo: Localize;
				...
				class start_open_preset_btn: start_create_new_btn
				{
					idc = 9136;

					text = "Open preset"; //--- ToDo: Localize;
					x = 101 * GUI_GRID_W;
					tooltip = "Open existing preset"; //--- ToDo: Localize;
					onButtonClick = "[] call EMM_fnc_openPresetManager";
				};
			};
		};
